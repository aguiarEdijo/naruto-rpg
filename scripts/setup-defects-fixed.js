...
async function migrateDefects() {
    ...
    try {
        ...
        if (insertError) {
            ...
            // Se a tabela não existe ou tem estrutura incorreta
            if (insertError.message.includes('Could not find the table') ||
                insertError.message.includes('Could not find the') ||
                insertError.message.includes('column') ||
                insertError.message.includes('does not exist')) {

                console.log('\n💡 A tabela defects não existe ou tem estrutura incorreta.');
