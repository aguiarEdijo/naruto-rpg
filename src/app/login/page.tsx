            ...
            <Card className="w-full max-w-md p-8">
                <div className="text-center mb-6">
                    ...
                    <p className="text-gray-600">
                        Faça login para acessar suas fichas de personagem
                    </p>
                </div>
                ...
                <Button
                    ...
                    className="w-full bg-[#5865F2] hover:bg-[#4752C4] text-white font-semibold py-3 px-6 rounded-lg transition-colors"
                >
