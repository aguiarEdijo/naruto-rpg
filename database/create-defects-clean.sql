-- Script para criar a tabela defects do zero
-- Execute este SQL no Supabase Dashboard APÓS remover as tabelas relacionadas

-- 1. Criar a tabela defects com estrutura completa
